...
```sh
  cd my-folder
  git clone git@github.com:CaptainBawa/School-Library-App.git
```
### Install
...
Feel free to check the [issues page](https://github.com/CaptainBawa/School-Library-App/issues).
...
This project is [MIT](https://github.com/CaptainBawa/School-Library-App/blob/development/LICENSE) licensed.
